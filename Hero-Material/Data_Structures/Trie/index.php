...
?>
					<div class="row">
						<div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
							...
							<p class="mypad">Η δομή <strong>Trie</strong> είναι η πρώτη δομή που μαθαίνει κανείς για κείμενα (strings). Μας επιτρέπει να κρατάμε ένα λεξικό, να ελέγχουμε σε βέλτιστο (γραμμικό ως προς το μέγεθος της λέξης) χρόνο αν μία λέξη υπάρχει στο λεξικό μας, και να εισάγουμε/εξάγουμε λέξεις από το λεξικό.</strong>. Οπτικά μοιάζει έτσι: <img src="trie.png" /></p>
							<p class="mypad">Ό,τι θα χρειαστούμε για να μάθουμε αυτή τη δομή βρίσκετε σε αυτές τις <a href="trie.pdf">διαφάνειες</a> (θυμόμαστε <a href="/PDP/read_pdf.php">αυτό</a>).</p>
