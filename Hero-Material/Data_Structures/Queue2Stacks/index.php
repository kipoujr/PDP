...
?>
					<div class="row">
						<div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
							...
							<p class="mypad">Η <strong>Queue with 2 Stacks</strong> είναι μία απλή queue, που όμως υλοποιείται με πολύ περίεργο τρόπο. Αντί να την χτίσουμε άμεσα, χτίζουμε 2 stacks, και με operations πάνω σε αυτές προσομοιώνουμε την queue. Ποιο το κέρδος; <img src="queue2stacks.png" /></p>
