...
?>
					<div class="row">
						<div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
							...
							<p class="mypad">Η δομή <strong>Aho-Corasick</strong> μας βοηθάει να βρούμε όλες τις εμφανίσεις όλων των λέξεων ενός λεξικού μέσα σε ένα μεγάλο κείμενο. Πριν την μάθουμε πρέπει οπωσδήποτε να έχουμε καταλάβει καλά τον αλγόριθμο για String Matching <a href="../../Strings/KMP/index.php">KMP</a>, όπως και τα <a href="../Trie/index.php">Tries</a>.</p>
							...
							<p class="mypad">Οπτικά έχουμε δύο ή τρία δέντρα, το ένα πάνω στο άλλο. Το πρώτο είναι ένα Trie (μαύρες ακμές προς τα μπροστά) των λέξεων του λεξικού. Το δεύτερο δέντρο (μπλε ακμές προς τα πίσω) μας επιτρέπει να διορθώνουμε τα λάθη μας όταν δεν έχουμε ταίριασμα, ακριβώς όπως συμβαίνει και στον KMP. Ανάλογα με την εφαρμογή μπορεί να έχουμε ένα τρίτο δάσος (συντόμευση του δεύτερου δέντρου, με πράσινες γραμμές προς τα πίσω), που κάνει ακριβώς την ίδια δουλειά με το δεύτερο, αλλά δείχνει πάντα σε ολόκληρες λέξεις, όχι σε προθέματά τους: <img src="aho-corasick.png" /></p>
							<p class="mypad">Διαβάζουμε θεωρία από τις <a title="Offline: <?php echo $_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF']); ?>/aho-corasick.pdf" href="https://web.stanford.edu/class/cs166/lectures/02/Small02.pdf">διαφάνειες</a> του Stanford (θυμόμαστε <a href="/PDP/read_pdf.php">αυτό</a>).</p>
						</div>
					</div>
					<div class="row">
