...
?>
					<div class="row">
						<div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
							...
							<p class="mypad">Η παρουσίαση εκτέλεσης (μαζί με κώδικα) για απάντηση σε ερωτήματα <em>ελάχιστης τιμής</em> δίνεται <a href="leaf-oriented_BSTs.pdf">εδώ</a>, και χρησιμοποίει το ίδιο ακριβώς τρικ αποθήκευσης της heap (θυμόμαστε <a href="/PDP/read_pdf.php">αυτό</a>). Παρακάτω θα αναλύσουμε την πολυπλοκότητα:</p>
							...
							<p class="mypad">Για να καταλάβουμε καλύτερα τη δομή, μπορούμε να πειραματιστούμε με <a href="https://visualgo.net/en/segmenttree">αυτή</a> την εφαρμογή. Στην ανανέωση βάζουμε L=R. Στο <a href="../Lazy_propagation/index.php">επόμενο</a> υποκεφάλαιο θα δούμε πώς να κάνουμε γενικά Range Updates με Lazy Propagation.</p>
						</div>
					</div>
					<div class="row">
