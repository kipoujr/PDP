...
?>
					<div class="row">
						<div class="col-md-9 col-lg-9 col-sm-9 col-xs-12">
							...
							<p class="mypad"><span class="color1">Σημειώσεις υλοποίησης</span>: Ο πίνακάς μας πρέπει να είναι μεγέθους 4*Ν. Μέχρι το 2*Ν προκύπτει επειδή πέρα από τα Ν φύλλα έχουμε και τους Ν-1 εσωτερικούς κόμβους. Η υπόλοιπη διαφορά οφείλεται στην heap αναπαράστασή μας. Αν δείτε στις διαφάνειες, η θέση του κόμβου [6,6] στον πίνακα είναι 24, δηλαδή ήδη πάνω από το 2*Ν=20. Αν σας αρκεί, το 4*Ν είναι πάντα αρκετό. Αν όχι, προσέξτε ότι η heap αναπαράσταση ´θεωρεί´ ότι το τελευταίο επίπεδο είναι γεμάτο. Ενώ εμείς πχ δε δίνουμε σε κανένα κόμβο την τιμή 18, και θα μπορούσε να ανατεθεί στον κόμβο [6,6], η heap αναπαράσταση φαντάζεται ότι οι κόμβοι [3,3], [4,4], [5,5] έχουν από δύο παιδιά, και σε αυτά τα υποθετικά παιδιά αναθέτει τις μικρές θέσεις μνήμης. Έτσι μπορεί να έχουμε κάποιο παιδί στο τελευταίο επίπεδο που έχει μεγάλη διεύθυνση, όπως το [6,6]. Αφού όμως τα φύλλα είναι Ν, το τελευταίο επίπεδο έχει μέγεθος το πολύ 2*Ν, κι άρα το 4*Ν  αρκεί για να δώσουμε διεύθυνση σε οποιοδήποτε κόμβο.</p>
							<p class="mypad">Επίσης άλλες υλοποιήσεις (όπως η ενδεικτική) διαλέγουν σωστά το παιδί (ή τα παιδιά) στα οποία πρέπει να κατέβει η αναδρομή. Άλλες πηγαίνουν και στα 2 παιδιά, κι απλώς επιστρέφουν αν το διάστημα του κόμβου είναι τελείως ξένο με το διάστημα του ερωτήματος. Διαλέξτε ό,τι σας ταιριάζει περισσότερο!</p>
